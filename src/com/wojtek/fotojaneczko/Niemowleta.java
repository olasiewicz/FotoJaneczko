...
public class Niemowleta extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.niemowleta);
		String url = "http://www.fotojaneczko.pl/niemowleta/index.html";
		
		webView = (WebView) findViewById(R.id.webViewNiemowleta);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_powrot:
			Intent galeriaIntent = new Intent(Niemowleta.this, GaleriaMenu.class);

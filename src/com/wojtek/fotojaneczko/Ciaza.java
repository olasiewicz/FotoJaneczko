...
public class Ciaza extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ciaza);
		String url = "http://www.fotojaneczko.pl/9miesiecy/index.html";
		
		webView = (WebView) findViewById(R.id.webViewCiaza);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_powrot:
			Intent galeriaIntent = new Intent(Ciaza.this, GaleriaMenu.class);
